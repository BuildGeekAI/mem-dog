...
Connect Gusto to mem-dog to sync payroll, employee, and benefits data.
...
3. Click **Connect**
4. Authorize mem-dog via Gusto's OAuth consent screen
...
Pull data from Gusto and store in mem-dog:
