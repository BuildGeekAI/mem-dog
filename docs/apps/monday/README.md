...
Connect Monday.com to mem-dog to sync boards, items, and workflow data.
...
3. Click **Connect**
4. Authorize mem-dog via Monday.com's OAuth consent screen
...
Pull data from Monday.com and store in mem-dog:
