...
Connect Zoho CRM to mem-dog to sync leads, contacts, deals, and custom modules.
...
3. Click **Connect**
4. Authorize mem-dog via Zoho CRM's OAuth consent screen
...
Pull data from Zoho CRM and store in mem-dog:
