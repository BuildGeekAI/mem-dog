...
Connect PayPal to mem-dog to sync payment data, transactions, and disputes.
...
3. Click **Connect**
4. Authorize mem-dog via PayPal's OAuth consent screen
...
Pull data from PayPal and store in mem-dog:
