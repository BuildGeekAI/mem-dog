"""ChatAgent — Processes chat and messaging transcripts."""

from ..base import BaseSubAgent


class ChatAgent(BaseSubAgent):
    """Processes chat and messaging transcripts (Slack exports, Teams, etc.)."""

    AGENT_TYPE = "chat"
    AGENT_PURPOSE = "Processes chat and messaging transcripts"
    MIME_PATTERNS = ["application/x-chat", "application/x-slack-export"]

    def _process(self, payload_json: str, data_id: str, group_context=None, payload_meta=None) -> dict:
        """Analyse chat transcript content using Gemma 3 1B.
