"""FeedAgent — Processes RSS and Atom feed data."""

from ..base import BaseSubAgent


class FeedAgent(BaseSubAgent):
    """Processes RSS and Atom feed data."""

    AGENT_TYPE = "feed"
    AGENT_PURPOSE = "Processes RSS and Atom feed data"
    MIME_PATTERNS = ["application/rss+xml", "application/atom+xml"]
    MODEL_TIER = "small"

    def _process(self, payload_json: str, data_id: str, group_context=None, payload_meta=None) -> dict:
        """Download and summarise RSS/Atom feed content using Gemma 3 1B.
