"""WebPageAgent — Processes scraped web page content."""

from ..base import BaseSubAgent


class WebPageAgent(BaseSubAgent):
    """Processes scraped web page content."""

    AGENT_TYPE = "web_page"
    AGENT_PURPOSE = "Processes scraped web page content"
    MIME_PATTERNS = ["application/x-web-scrape"]
    MODEL_TIER = "large"

    def _process(self, payload_json: str, data_id: str, group_context=None, payload_meta=None) -> dict:
        """Download and summarise web page content using Gemma 3 1B.
