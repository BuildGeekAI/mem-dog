"""GpsAgent — Processes GPS location data and tracks."""

from ..base import BaseSubAgent


class GpsAgent(BaseSubAgent):
    """Processes GPS location data and tracks."""

    AGENT_TYPE = "gps"
    AGENT_PURPOSE = "Processes GPS location data and tracks"
    MIME_PATTERNS = ["application/x-gps", "application/gpx+xml"]
    MODEL_TIER = "small"

    def _process(self, payload_json: str, data_id: str, group_context=None, payload_meta=None) -> dict:
        """Analyse GPS track data using Gemma 3 1B.
