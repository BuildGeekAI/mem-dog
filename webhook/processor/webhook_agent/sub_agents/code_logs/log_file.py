"""LogFileAgent — Processes log files."""

from ..base import BaseSubAgent


class LogFileAgent(BaseSubAgent):
    """Processes log files (.log)."""

    AGENT_TYPE = "log_file"
    AGENT_PURPOSE = "Processes log files"
    MIME_PATTERNS = ["text/x-log", "application/x-log"]

    def _process(self, payload_json: str, data_id: str, group_context=None, payload_meta=None) -> dict:
        """Download and analyse log file content using Gemma 3 1B.
