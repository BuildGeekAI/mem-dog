"""JsonAgent — Processes JSON data payloads."""

from ..base import BaseSubAgent


class JsonAgent(BaseSubAgent):
    """Processes JSON data payloads."""

    AGENT_TYPE = "json"
    AGENT_PURPOSE = "Processes JSON data payloads"
    MIME_PATTERNS = ["application/json"]
    MODEL_TIER = "small"

    def _process(self, payload_json: str, data_id: str, group_context=None, payload_meta=None) -> dict:
        """Download and analyse JSON content using Gemma 3 1B.
