"""CsvAgent — Processes CSV and TSV tabular data."""

from ..base import BaseSubAgent


class CsvAgent(BaseSubAgent):
    """Processes CSV and TSV tabular data."""

    AGENT_TYPE = "csv"
    AGENT_PURPOSE = "Processes CSV and TSV tabular data"
    MIME_PATTERNS = ["text/csv", "text/tab-separated-values"]
    MODEL_TIER = "small"

    def _process(self, payload_json: str, data_id: str, group_context=None, payload_meta=None) -> dict:
        """Download and analyse CSV/TSV content using Gemma 3 1B.
