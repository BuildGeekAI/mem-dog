"""HtmlDocAgent — Processes HTML documents and scraped web content."""

from ..base import BaseSubAgent


class HtmlDocAgent(BaseSubAgent):
    """Processes HTML documents and scraped web content."""

    AGENT_TYPE = "html_doc"
    AGENT_PURPOSE = "Processes HTML documents and scraped web content"
    MIME_PATTERNS = ["text/html"]

    def _process(self, payload_json: str, data_id: str, group_context=None, payload_meta=None) -> dict:
        """Download and analyse HTML content using Gemma 3 1B.
