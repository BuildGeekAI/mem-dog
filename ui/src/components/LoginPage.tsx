    ...
    <div className="relative bg-black text-white" style={{ overflowX: 'clip' }}>
      ...
      <section className="relative border-t border-white/5 py-20">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-xs text-white/25">Enterprise inquiries: <a href="mailto:pagarwal@buildgeek.ai" className="text-cyan-400/60 hover:text-cyan-400 transition-colors">pagarwal@buildgeek.ai</a></p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6 py-10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2 text-white/30 text-sm">
              ...
              <span>Private AI Memory Platform</span>
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-white/[0.04] flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-white/15">
            ...
            <div className="flex items-center gap-4">
              <a href="mailto:pagarwal@buildgeek.ai" className="hover:text-white/30 transition-colors">Contact</a>
